...
# main config
PLUGINSLUG="acf-autosize"
CURRENTDIR=`pwd`
MAINFILE="acf-autosize.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="https://plugins.svn.wordpress.org/acf-autosize/" # Remote SVN repo on wordpress.org, with trailing slash
